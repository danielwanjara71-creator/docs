...
<Steps>
  ...
  <Step title="Default View: Current Month" icon="calendar-check">
    ...
    <div align="center">
      <img src="/images/deliveries-default-month.jpeg" alt="Current Month Deliveries" style={{width: '100%', maxWidth: '300px', margin: '0 auto', borderRadius: '12px', boxShadow: '0 4px 14px 0 rgba(118, 189, 34, 0.3)' }} />
    </div>
  </Step>
</Steps>
