...
<Steps>
  ...
  <Step title="Default View: The Current Year" icon="sack-dollar">
    ...
    <div align="center">
      <img src="/images/payments-default-year.jpeg" alt="Current Year Payments Ledger" style={{width: '100%', maxWidth: '300px', margin: '0 auto', borderRadius: '12px', boxShadow: '0 4px 14px 0 rgba(118, 189, 34, 0.3)' }} />
    </div>
  </Step>
</Steps>
