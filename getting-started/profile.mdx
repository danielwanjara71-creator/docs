...
<Steps>
  ...
  <Step title="Select Preferred Language">
    ...
    <Frame>
      <img src="/images/language-selection.jpeg" alt="Sasini App Language Selection Screen" className="rounded-lg" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/farmer-validation.jpeg" alt="Farmer ID Validation Screen" className="rounded-lg" />
</Frame>
...
<Steps>
  ...
  <Step title="Legal Agreements">
    ...
    <Frame>
      <img src="/images/registration-details.jpeg" alt="Registration Details and Password Screen" className="rounded-lg" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/email-verification.jpeg" alt="Email Verification Prompt Screen" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/images/main-dashboard.jpeg" alt="Sasini App Main Dashboard" className="rounded-lg" />
</Frame>
