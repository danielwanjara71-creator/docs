...
<Steps>
  <Step title="Input Farmer ID">
    The user is required to input their officially registered **Sasini Farmer ID**. This establishes the crucial link between the digital account and real-world delivery records.
  ...
  <Step title="System Verification">
    The Easyway Web API queries the central database. If verified, the app retrieves the farmer's foundational profile data and authorizes progression to the security setup phase. If invalid, the process is securely halted.
