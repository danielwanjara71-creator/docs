...
<p style={{ color: '#A3E635', fontSize: '1.2rem', fontWeight: '500', marginBottom: '2rem' }}>
  Take full control of your Sasini experience. Manage your account, adjust your settings, access deep educational resources, and get help exactly when you need it.
</p>
