...
<div align="center">
  <img src="/images/agrishop.jpeg" alt="Agri Shop Categories and Products" style={{width: '100%', maxWidth: '300px', margin: '0 auto', borderRadius: '12px', boxShadow: '0 4px 14px 0 rgba(118, 189, 34, 0.3)' }} />
</div>
...
<Steps>
  ...
  <Step title="Submit & Confirm">
    ...
    3. A unique **Order ID** (e.g., `OD-***849***`) is generated instantly and also sent to your notifications page under **Orders** Tab.
      ...
      <div align="center">
        <img src="/images/cart.jpeg" alt="Checkout Success and Order ID" style={{width: '100%', maxWidth: '300px', margin: '0 auto', borderRadius: '12px', boxShadow: '0 4px 14px 0 rgba(118, 189, 34, 0.3)' }} />
      </div>
  </Step>
...
<div align="center">
     <img src="/images/not.jpeg" alt="Checkout Success and Order ID" style={{width: '100%', maxWidth: '300px', margin: '0 auto', borderRadius: '12px', boxShadow: '0 4px 14px 0 rgba(118, 189, 34, 0.3)' }} />
</div>
...
<div align="center">
  <img src="/images/cancel.jpeg" alt="Agri Shop Categories and Products" style={{width: '100%', maxWidth: '300px', margin: '0 auto', borderRadius: '12px', boxShadow: '0 4px 14px 0 rgba(118, 189, 34, 0.3)' }} />
</div>
